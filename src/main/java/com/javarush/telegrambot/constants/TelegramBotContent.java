...
public class TelegramBotContent {
    ...
    public static final String FINAL_TEXT = """
            *Кот Хакер, уровень пятый.*
            ...
            Чтобы начать заново приключения кота-хакера нажми на /start
            """;

    public static final String TASK_COMPLETED_TEXT = """
            Это задание уже выполнено.
            Продолжай выполнять задания или нажми на /start чтоб начать заново.
            """;

    public static final String GAME_OVER_TEXT = """
            Ты уже выполнил все задания. Нажми на /start чтоб начать заново.
            """;
